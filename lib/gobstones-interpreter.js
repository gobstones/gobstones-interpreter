...
LOCALE_PT['errmsg:procedure-arity-mismatch'] = function (name, expected, received) {
  return 'O procedimento "' + name + '" espera receber ' + LOCALE_ES['<n>-parameters'](expected) + ' mas é invocado com ' + LOCALE_ES['<n>-arguments'](received) + '.';
};

LOCALE_PT['errmsg:function-arity-mismatch'] = function (name, expected, received) {
  return 'A função "' + name + '" espera receber ' + LOCALE_ES['<n>-parameters'](expected) + ' mas é invocado com ' + LOCALE_ES['<n>-arguments'](received) + '.';
};

LOCALE_PT['errmsg:structure-pattern-arity-mismatch'] = function (name, expected, received) {
  return 'O construtor "' + name + '" tem ' + LOCALE_ES['<n>-fields'](expected) + ' mas o padrão tem ' + LOCALE_ES['<n>-parameters'](received) + '.';
};
...
LOCALE_PT['errmsg:primitive-arity-mismatch'] = function (name, expected, received) {
  return 'A operação "' + name + '" espera receber ' + LOCALE_ES['<n>-parameters'](expected) + ' mas é invocada com ' + LOCALE_ES['<n>-arguments'](received) + '.';
};
...
/* BEGIN LOCALE_EN */
var LOCALE_EN = {};
for (var _key in LOCALE_ES) {
  LOCALE_EN[_key] = LOCALE_ES[_key];
}
...
var ASTExprList = exports.ASTExprList = function (_ASTNode26) {
  _inherits(ASTExprList, _ASTNode26);
...
var ASTExprRange = exports.ASTExprRange = function (_ASTNode27) {
  _inherits(ASTExprRange, _ASTNode27);
...
var ASTExprTuple = exports.ASTExprTuple = function (_ASTNode28) {
  _inherits(ASTExprTuple, _ASTNode28);
...
var ASTExprStructure = exports.ASTExprStructure = function (_ASTNode29) {
  _inherits(ASTExprStructure, _ASTNode29);
...
var ASTExprStructureUpdate = exports.ASTExprStructureUpdate = function (_ASTNode30) {
  _inherits(ASTExprStructureUpdate, _ASTNode30);
...
var ASTExprFunctionCall = exports.ASTExprFunctionCall = function (_ASTNode31) {
  _inherits(ASTExprFunctionCall, _ASTNode31);
...
var ASTFieldBinding = exports.ASTFieldBinding = function (_ASTNode32) {
  _inherits(ASTFieldBinding, _ASTNode32);
...
var ASTConstructorDeclaration = exports.ASTConstructorDeclaration = function (_ASTNode33) {
  _inherits(ASTConstructorDeclaration, _ASTNode33);
